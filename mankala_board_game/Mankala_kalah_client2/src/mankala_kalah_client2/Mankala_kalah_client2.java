...
public class Mankala_kalah_client2 {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println();
        System.out.print("Enter the port no(1343): ");
        int port = ss.nextInt();
        ...
        Socket sock = new Socket("localhost", 1343);
        System.out.println("C-C: Client2 is connected!!!!");
        System.out.println();
        ...
        //client2 receiving info and parses it out
        ...
        //client2_first_or_second_player
        String client2_first_or_second_player="";
        client2_first_or_second_player= client2_first_or_second_player+info.charAt(6+seeds_str.length()+1+time_str.length()+2);
        ...
        if(random_dist.equals("S")){
            ...
            looping_and_heeping(board,game,client2_first_or_second_player,time, in,out);
        }
    ...
    public static void looping_and_heeping(Board board, kalah_game game,String client2_first_or_second_player, int time, BufferedReader in,PrintWriter out) throws IOException{
        ...
        if(res.equals("BEGIN")){
            ...
            System.out.println();
            if(client2_first_or_second_player.equals("F")){  //client2 is first player
                //asks user for IO input as many moves needed within time
                Vector<Integer> c2_moves_int = new Vector<Integer>();
            
                int ret =1;    
                while(ret ==1){
                    String movess = input(time, board);      //take user move as string
                    int moves = Integer.parseInt(movess);
                    c2_moves_int.add(moves);  //store it in vector
                    ret = game.make_a_move(board, 2, moves);
                    if(ret == 1){
                ...
                String fina = "";
                for(int i =0;i<c2_moves_int.size();i++){
                    String temp ="";
                    temp = temp + Integer.toString(c2_moves_int.elementAt(i))+" ";
                    fina= fina + temp;
                }
            ...
            else if(client2_first_or_second_player.equals("S")){   //client2 is second player
                //call this funtion again
                looping_and_heeping(board,game,client2_first_or_second_player,time,in,out);
            }
        }
        ...
        //client - parses the moves in int/ updates the baord / sends OK to server 
         ...
         //calls this funtion again
            ...
            for(int i =0;i<server_moves.size();i++){
                int ret = game.make_a_move(board, 1, server_moves.elementAt(i));
            }
            
            System.out.println("Client2 receives server moves and updated its board");
            board.p1_print_board(board);
            System.out.println();
            ...
            client_makes_move(res, board,game,client2_first_or_second_player,time, in,out);
        }  
    }
    
    public static void client_makes_move(String res, Board board, kalah_game game,String client2_first_or_second_player, int time, BufferedReader in,PrintWriter out) throws IOException{
            ...
            Timer timer = new Timer();
                ...
                public void run() {
                    ...
                    try {
                        mes = in.readLine();
                        if(mes.equals("TIME")){
                            System.out.println("Client2 timed out and Lost");  
                            System.exit(0);
                        }
            ...
            while(ret ==1){
                ...
                if(moves.equals("P")){
                   ...
                   if(pie_ret.equals("OK")){
                    ...
                    c2_moves_int.add(value);            //store it in vector
                    ret = game.make_a_move(board, 2, value);
                }
    ...
    public static String input(int time, Board board){
        ...
        board.p1_print_board(board);  
        System.out.println();
        System.out.print("client2 please make a move: ");
